...
namespace IdentityMvcDemo.Models.Gotchas
{
    public class ValidateCodeHelper
    {
        ...
        public string CreateValidateCode(int length)
        {
            ...
            for (var i = 0; i < length; i++)
            {
                ...
                var powNumber = 1 * (int)Math.Pow(10, length);
                randMembers[i] = rand.Next(powNumber, int.MaxValue);
            }
            ...
            for (var i = 0; i < length; i++)
            {
                ...
                validateNumbers[i] = int.Parse(numStr.Substring(numPosition, 1));
            }

            //生成验证码
            for (var i = 0; i < length; i++)
            {
                validateNumberStr += validateNumbers[i].ToString();
            }
